        ...
        <form method='post' action='<?= URL ?>addEditCategory'>
            ...
            <div class='form-group my-3'>
                ...
                <input type='text' name='categoryName' class='form-control' id='categoryName'
                    placeholder="Nom de la catégorie" required autofocus
                    value='<?= isset($category) ? htmlentities($category->getCategoryName()) : '' ?>'>
            </div>
            <div class='form-group my-3'>
                ...
                <input type='text' name='categoryDescription' class='form-control' id='categoryDescription'
                    placeholder='Description de la catégorie' required
